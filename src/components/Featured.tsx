...
export default function Featured() {
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center min-h-screen px-6 py-12 lg:py-0" style={{background: "linear-gradient(to bottom, #ffffff 0%, #707070 100%)"}} id="tours">
